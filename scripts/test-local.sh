...
sh "$ROOT_DIR/packages/agent/scripts/test-run-no-custom-dockerfile.sh"
sh "$ROOT_DIR/packages/agent/scripts/test-custom-dockerfile.sh"
sh "$ROOT_DIR/packages/agent/scripts/test-compact-custom-dockerfile.sh"
